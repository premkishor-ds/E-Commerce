...
export class ProfileController {
  ...
  @ApiOperation({
    summary:
      'Retrieve currently logged-in user, seller, or vendor profile details',
  })
  ...
  @Put('update')
  @ApiOperation({
    summary: 'Update personal profile details or merchant shop settings',
  })
  ...
  @Get('addresses')
  @ApiOperation({
    summary: 'List all customer saved shipping/billing addresses',
  })
  ...
  @HttpCode(200)
  @ApiOperation({
    summary: 'Change user/seller/vendor console account password',
  })
  ...
  @HttpCode(200)
  @ApiOperation({
    summary: 'Enable or disable Multi-Factor Authentication (2FA)',
  })
  async toggleTfa(
    @Request() req: any,
  ...
  @ApiOperation({
    summary: 'Terminate all active device sessions except current',
  })
  async revokeOtherSessions(
    @Request() req: any,
    @Query('currentDeviceId') currentDeviceId: string,
  ) {
    return this.profileService.revokeOtherSessions(
      req.user.id,
      currentDeviceId,
    );
  }
  ...
  @Get('wallet')
  @ApiOperation({
    summary: 'Retrieve wallet transaction ledger and cashback statements',
  })
  ...
  @Post('wallet')
  @ApiOperation({
    summary: 'Simulate adding cash funds to user wallet balance',
  })
  ...
  @HttpCode(200)
  @ApiOperation({
    summary: 'Convert reward points to wallet shopping balance credit',
  })
  ...
  @Get('payments')
  @ApiOperation({
    summary: 'List customer saved tokenized cards, UPIs, or wallets',
  })
  ...
  @Get('referrals')
  @ApiOperation({
    summary: 'Get referral codes, link clicks, and referred user logs',
  })
  ...
  @Get('logs')
  @ApiOperation({
    summary: 'Retrieve security audit log trail of account updates',
  })
  ...
  @Get('export')
  @ApiOperation({
    summary: 'GDPR Right to Portability: Download full personal data snapshot',
  })
