  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 p-4 bg-indigo-650 hover:bg-indigo-500 hover:scale-105 active:scale-95 text-white rounded-full shadow-2xl transition-all flex items-center gap-2 cursor-pointer font-bold text-xs border-0"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/55 backdrop-blur-md p-4 overflow-y-auto">
          <div className="w-full max-w-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto space-y-4">
            <button
              ...
              className="absolute top-4 right-4 p-1 rounded-full text-zinc-405 hover:bg-zinc-100 dark:hover:bg-zinc-850 bg-transparent border-0 cursor-pointer"
            >
              <X className="h-5 w-5" />
            </button>
            <div className="text-center">
              <h2 className="text-lg font-black text-zinc-905 dark:text-white">Feedback Center</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border dark:border-zinc-800 bg-white dark:bg-zinc-955 rounded-lg text-zinc-805 dark:text-white outline-none"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border dark:border-zinc-800 bg-white dark:bg-zinc-955 rounded-lg text-zinc-805 dark:text-white outline-none focus:border-indigo-500"
                />
              </div>
                    ...
                    {duplicates.map((item: any) => (
                      <div key={item._id} className="flex justify-between items-center bg-white dark:bg-zinc-900 border dark:border-zinc-850 p-2 rounded-lg gap-3">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 bg-indigo-655 text-white rounded text-[9px] font-bold shrink-0 hover:bg-indigo-500 border-0 cursor-pointer"
                        >
                          Vote (+1)
                        </button>
                      </div>
