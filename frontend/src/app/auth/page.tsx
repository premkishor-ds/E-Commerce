...
import { Lock, Mail, Phone, Shield, ArrowRight } from 'lucide-react';
          ...
          {!otpMode && (
            <div className="space-y-4 pt-4 border-t border-zinc-100 dark:border-zinc-800">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <button
                  onClick={() => {
                    login('google-user@oauth.com', 'Customer', 'OAUTH-GG-TOKEN');
                    router.push('/');
                  }}
                ...
                <button
                  onClick={() => {
                    login('github-user@oauth.com', 'Customer', 'OAUTH-GH-TOKEN');
                    router.push('/');
                  }}
                  className="flex items-center justify-center gap-2 rounded-xl border border-zinc-200 py-2.5 text-xs font-semibold hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-950 text-zinc-900 dark:text-white"
                >
