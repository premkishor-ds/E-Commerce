...
- Name: tests\chatbot.spec.ts >> Chatbot Guest User Actions >> Login workflow via Chatbot
- Location: tests\chatbot.spec.ts:150:7
...
Received string:    "I'm sorry, I couldn't quite understand that. Would you like to check out some popular products, view your orders, or open a help ticket?03:39 PM"
```
